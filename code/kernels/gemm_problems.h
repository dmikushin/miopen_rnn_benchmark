...
std::vector<std::tuple<int, int, int, bool, bool>> training_set = {
    std::make_tuple(64, 3136, 256, true, false),
    std::make_tuple(256, 3136, 64, true, false),
    std::make_tuple(128, 784, 512, true, false),
    std::make_tuple(512, 784, 128, true, false),
    std::make_tuple(256, 196, 1024, true, false),
    std::make_tuple(1024, 196, 256, true, false),
    std::make_tuple(512, 49, 2048, true, false),
    std::make_tuple(2048, 49, 512, true, false),
    std::make_tuple(64, 3136, 256, false, false),
    std::make_tuple(256, 3136, 64, false, false),
    std::make_tuple(128, 784, 512, false, false),
    std::make_tuple(512, 784, 128, false, false),
    std::make_tuple(256, 196, 1024, false, false),
    std::make_tuple(1024, 196, 256, false, false),
    std::make_tuple(512, 49, 2048, false, false),
    std::make_tuple(2048, 49, 512, false, false),
    std::make_tuple(256, 512, 512, false, false),
    std::make_tuple(256, 512, 2048, false, false),
    std::make_tuple(256, 2048, 512, false, false),
    std::make_tuple(256, 512, 512, true, false),
    std::make_tuple(256, 512, 2048, true, false),
    std::make_tuple(256, 2048, 512, true, false),
    std::make_tuple(512, 256, 512, false, false),
    std::make_tuple(2048, 256, 512, false, false),
    std::make_tuple(512, 256, 2048, false, false),
    std::make_tuple(512, 256, 512, true, false),
    std::make_tuple(2048, 256, 512, true, false),
    std::make_tuple(512, 256, 2048, true, false)
};
